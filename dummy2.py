    ...
    if st.session_state.main_menu == "IKPA":
        ...
        if menu_digital == "📈 Chart Utama":
            ...
            if periode_chart_kkp == "Bulanan":
                ...
                tw = int(_kkp_tw_selected.replace("TW", ""))
...
def main():
    ...
    if st.sidebar.button("📱 Notifikasi Satker", use_container_width=True):
        st.session_state.page = "Notifikasi Satker"
    ...
    **Muhamad Ameer Noor**  
    ...
    elif st.session_state.page == "Notifikasi Satker":
        page_notifikasi()
